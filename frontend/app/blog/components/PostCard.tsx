...
export default function PostCard({ post, isFeatured = false }: PostCardProps) {
  ...
  return (
    <Link href={`/posts/${post.slug}`} className="group block">
      <article className="flex flex-col rounded-lg hover:bg-gray-50 transition-colors duration-200">
        ...
        <div className="relative w-full aspect-video overflow-hidden rounded-lg bg-gray-100">
          ...
          {isFeatured && (
            <div className="absolute top-3 left-3">
              <svg width="80" height="28" className="inline-block">
                <rect width="100%" height="100%" fill="#bc2026" rx="2" />
                <text x="40" y="18" textAnchor="middle"
                      fontSize="11" fontWeight="bold" fill="white" letterSpacing="0.3px"
